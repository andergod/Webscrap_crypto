...
def cryptonews_relevantpost()->list:
...
def coindesk_relevantpost()->list:
...
def independent_relevantpost()->list:
...
def text_from_relevant(link:str, type:str)->str:
